...
Shader "Explode"
{
	Properties
	{
		...
		_T_Porte_Albedo("T_Porte_Albedo", 2D) = "white" {}
		_T_Porte_Normal("T_Porte_Normal", 2D) = "bump" {}
		_T_Porte_SME("T_Porte_SME", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _T_Porte_Normal;
		uniform float4 _T_Porte_Normal_ST;
		uniform sampler2D _T_Porte_Albedo;
		uniform float4 _T_Porte_Albedo_ST;
		uniform sampler2D _T_Porte_SME;
		uniform float4 _T_Porte_SME_ST;
		...
		{
			float2 uv_T_Porte_Normal = i.uv_texcoord * _T_Porte_Normal_ST.xy + _T_Porte_Normal_ST.zw;
			o.Normal = UnpackNormal( tex2D( _T_Porte_Normal, uv_T_Porte_Normal ) );
			float2 uv_T_Porte_Albedo = i.uv_texcoord * _T_Porte_Albedo_ST.xy + _T_Porte_Albedo_ST.zw;
			o.Albedo = tex2D( _T_Porte_Albedo, uv_T_Porte_Albedo ).rgb;
			float2 uv_T_Porte_SME = i.uv_texcoord * _T_Porte_SME_ST.xy + _T_Porte_SME_ST.zw;
			float4 tex2DNode88 = tex2D( _T_Porte_SME, uv_T_Porte_SME );
			o.Emission = ( tex2DNode88.b * _EmissiveColor ).rgb;
			o.Metallic = tex2DNode88.g;
			o.Smoothness = tex2DNode88.r;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16900
0;521;1345;479;-661.7003;85.92853;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;82;-3427.562,-230.3002;Float;False;Property;_Player1;Player1;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;10;-3645.85,-215.3022;Float;False;Global;P1;P1;0;0;Create;True;0;0;False;0;0,0,0;-87.64821,0.75,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;42;-3602.061,-338.742;Float;False;41;RebuildedUVs;1;0;OBJECT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.Vector3Node;80;-3644.018,-38.6151;Float;False;Global;P2;P2;0;0;Create;True;0;0;False;0;0,0,0;-91.69379,-1.75,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TFHCCompareEqual;81;-3296.562,-104.3002;Float;False;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;49;1023.394,521.0009;Float;False;48;ExplosionBlastIntensity;1;0;OBJECT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;59;992.4738,447.1598;Float;False;58;ProjectilesDirectionRotation;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;88;1195.557,-79.45876;Float;True;Property;_T_Porte_SME;T_Porte_SME;8;0;Create;True;0;0;False;0;835e7742a6c7cf8418a0befe06ca944d;0186353a84b0ebd4693ca65d0e323369;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;89;1257.801,132.794;Float;False;Property;_EmissiveColor;EmissiveColor;9;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;87;1027.358,-252.8727;Float;True;Property;_T_Porte_Normal;T_Porte_Normal;7;0;Create;True;0;0;False;0;76b8076ed73093e45b9bdfc97ad146ef;e2c5f612ae633304e933d68d3a9ddc15;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;86;1400.041,-354.3758;Float;True;Property;_T_Porte_Albedo;T_Porte_Albedo;6;0;Create;True;0;0;False;0;7d83ac80c3449d14084c507e715c0bee;aebeacd295059f84394896faf418f7a1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;75;1054.147,625.4508;Float;False;74;ProjectilesNormals;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;1310.448,476.8787;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;1513.7,77.07147;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1896.303,-26.69087;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Explode;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;3;88;2
WireConnection;0;4;88;1
WireConnection;0;11;38;0
WireConnection;0;12;75;0
ASEEND*/
//CHKSM=1E953F90088600A1AEC058BFC8E8A619FF54EF81